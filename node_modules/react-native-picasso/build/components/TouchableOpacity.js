...
const PicassoTouchableOpacity = React.forwardRef((props, ref) => {
    ...
    return (<theming_1.ThemeContext.Consumer>
        {(theme) => {
        var _a;
        const picassoStyle = style_helpers_1.buildStyleSheet(className, 'view', theme);
        return (<react_native_1.TouchableOpacity ref={ref} style={[
            { borderColor: (_a = theme.colors) === null || _a === void 0 ? void 0 : _a.border },
            picassoStyle,
            style,
        ]} {...others}>
              {children}
...
exports.default = PicassoTouchableOpacity;
